...
def process_posts(raw_file_path,processed_file="data/processed_posts.json"):
    enriched_posts=[]
...
def get_unified_tags(posts_with_metadata):
    ...
    1. Tags are unified and merged to create a shorter list.
        ...
        Example 3: "Personal Growth", "Personal Development", "Self Improvement" can be mapping to "Self Improvement"
...
def extract_metadata(post):
    ...
    3. tags is an aray of text tags. Extract maximum two tags.
